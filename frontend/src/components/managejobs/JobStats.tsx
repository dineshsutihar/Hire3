...
const StatCard: React.FC<StatCardProps> = ({ icon, label, value, trend, color, bgColor }) => (
    <Card className="p-5 relative overflow-hidden">
        ...
        <div className={`absolute bottom-0 left-0 right-0 h-1 ${color.replace('text-', 'bg-').split(' ')[0]}`} />
    </Card>
);
